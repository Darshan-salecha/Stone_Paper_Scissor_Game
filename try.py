...
l=[]
def genetate():
    D={0:"Stone",1:"Paper",2:"Scissor"}
    x=random.randint(0,2)
    threading.Timer(2,genetate).start()
    l.append(D[x])
...
while(True):
    ...
    scissors = sci_cascade.detectMultiScale(gray, 1.15,50)
